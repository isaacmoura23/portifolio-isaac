...
const navItems = [
  ...
  { label: "Skills", href: "#workbench" },
  { label: "Contato", href: "#connect" },
]

const socialLinks = [
  { label: "GitHub", href: "https://github.com/isaacmoura23", icon: Github },
  { label: "LinkedIn", href: "https://linkedin.com/in/isaac-moura", icon: Linkedin },
]
