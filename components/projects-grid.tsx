...
const projects = [
  {
    id: 0,
    title: "Plataforma Bancária Digital",
    description:
      "Plataforma bancária digital completa construída do zero. Backend robusto com Spring Boot, autenticação segura via JWT, persistência com Spring Data JPA/Hibernate e infraestrutura containerizada com Docker.",
    tags: ["Java", "Spring Boot", "JWT", "PostgreSQL", "Docker", "Hibernate"],
    status: "shipped",
    year: "2024",
    stars: 0,
    forks: 0,
  ...
  },
  {
    ...
    title: "Zyntra ERP",
    description:
      "Atuação como Desenvolvedor Fullstack em sistema ERP empresarial. Implementação de metodologias ágeis, auditoria de sistemas, testes de software, correção de bugs e propostas de melhoria de performance.",
    tags: ["Fullstack", "ERP", "Scrum", "Node.js", "Angular"],
    status: "in-progress",
    year: "2025",
    stars: 0,
    forks: 0,
  ...
  {
    id: 2,
    title: "API RESTful com Microsserviços",
    description:
      "Arquitetura de microsserviços assíncronos com Apache Kafka para produção e consumo de eventos. APIs RESTful seguras com boas práticas de Clean Code.",
    tags: ["Java", "Spring Boot", "Apache Kafka", "Microsserviços"],
    status: "shipped",
    year: "2024",
    stars: 0,
    forks: 0,
  ...
  {
    id: 3,
    title: "Dashboard Admin Angular",
    description:
      "Painel administrativo moderno desenvolvido com Angular, integrando APIs REST e gerenciamento de estado. Interface responsiva com HTML5/CSS3.",
    tags: ["Angular", "TypeScript", "HTML5", "CSS3", "REST API"],
    status: "shipped",
    year: "2024",
    stars: 0,
    forks: 0,
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 sm:mb-14 flex flex-col gap-6 sm:gap-8 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-3 animate-fade-in-up">
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">Projetos</h2>
          </div>
