...
const roles = ["building backends", "crafting APIs", "shipping products", "architecting systems", "solving problems"]
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-3 animate-fade-in-up">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
                Isaac Moura — Full Stack Developer
              </p>
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              ...
              <span className="text-foreground font-medium">Java (Spring Boot)</span> e{" "}
              <span className="text-foreground font-medium">Angular</span>, com experiência em microsserviços, APIs RESTful seguras com JWT e infraestrutura com{" "}
              <span className="text-foreground font-medium">Docker</span>. Baseado em Fortaleza, CE — disponível para projetos remotos.
            </p>
