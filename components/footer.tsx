...
const socialLinks = [
  ...
  { label: "LinkedIn", href: "https://linkedin.com/in/isaac-moura", handle: "/in/isaac-moura", icon: Linkedin },
  { label: "Email", href: "mailto:zackisaacdev@gmail.com", handle: "zackisaacdev@gmail.com", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-balance">
                ...
                <span className="bg-gradient-to-l from-primary/50 to-accent text-transparent bg-clip-text ">juntos</span>
              </h2>
            </div>
            <p className="max-w-md text-base sm:text-lg text-muted-foreground leading-relaxed">
              Disponível para projetos freelance, colaborações e oportunidades remotas. Me manda uma mensagem e a gente conversa sobre o seu projeto.
            </p>

            <div className="pt-2">
              <a
                href="mailto:zackisaacdev@gmail.com"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} Isaac Moura — Todos os direitos reservados
          </p>
        </div>
      </div>
    </footer>
